...
os.system("figlet -f small Tools V3 |lolcat")
...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print 'Intert Lagi Di Check Waras Atau Ga:v'
